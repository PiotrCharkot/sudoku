...
const RankEasyScreen = () => {
  ...
  const getDataFromFB = (doc) => {
    setNumberOfGames(doc.data().numberOfGamesH);
    setFinishedGames(doc.data().numberOfFinishedGamesH);
    setBestTime(doc.data().bestTimeH);
    setTotalTime(doc.data().totalTimeH);
    setShowResult(true);
  };
