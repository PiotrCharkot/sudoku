...
const RankEasyScreen = () => {
  ...
  const getDataFromFB = (doc) => {
    setNumberOfGames(doc.data().numberOfGamesP);
    setFinishedGames(doc.data().numberOfFinishedGamesP);
    setBestTime(doc.data().bestTimeP);
    setTotalTime(doc.data().totalTimeP);
    setShowResult(true);
  };
